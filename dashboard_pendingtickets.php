...
$smarty->assign("title","Pending Tickets detail");
...
$smarty->assign("TitleTickets","Pending Tickets");
$smarty->assign("SubTitleTickets","pending ticket(s).");
...
Where
  raynet_glpi_tickets.status  =4 And
