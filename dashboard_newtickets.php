...
$smarty->assign("TitleTickets","New Tickets");
$smarty->assign("SubTitleTickets","new ticket(s).");
$smarty->assign("SubTitleTicket","New ticket from ");
...
$i=0;
    ...
    while ($row = mysqli_fetch_array($data)) {
        ...
        if ($row[8] != '')
        {
          str_replace('.', '_min.', $row[8]);
          $Tickets[$i]['picture'] = $glpi_server_url . "/front/document.send.php?file=_pictures/" . $row[8];
        }
        else
        {
          $Tickets[$i]['picture'] = '';
